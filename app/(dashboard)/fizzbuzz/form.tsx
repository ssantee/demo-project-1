...
export default function FizzbuzzForm({ setResults, working, setWorking, error, setError }: {
    ...
    async function onSubmit(values: formSchema) {
        ...
        if (result.result) {
            ...
            // sort descending
            setResults(prev => [...prev, output].sort((a, b) =>
                        ...
                        <CollapsibleContent>
                            ...
                            <div>
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            <FormLabel>Existing Collection</FormLabel>
                                            <FormDescription>
                                                Optional: Add an existing set to have it FizzBuzzed
                                            </FormDescription>
                                            <FormControl>
                                                <Input
                                                    type="text"
                                ...
                                <Form {...form2}>
                                    <button
                                        ...
                                        disabled={working}
                                        type="button"
                                        onClick={form2.handleSubmit(async (values) => {
                                            setWorking(true);
                                            setError(null);
                                            // use default values
                                            ...
                                            if (result) {
                                                form.setValue('existingCollection', result.result?.join(', ') || '');
                                                setWorking(false);
                                                setError(null);
                                            } else {
                                                setError("Failed to generate Fibonacci sequence");
                                            }
                                        })}
                                    >
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        <FormDescription>
                                            Optional: Add alternate pairings for FizzBuzz (e.g., 7: "Bazz").
                                        </FormDescription>
                                        <FormControl>
                                            <Input
                                                type="text"
